    ...
    def run(self):
        ...
        if (blue >= 3500):
            ...
            for i in range(1, strip.numPixels(), 2):
                #flash lights to show start of measurements visually
            ...
            subprocess.call(['/home/pi/Documents/Android_to_RPi3_communication/pull.sh'])
...
class LineFinder (threading.Thread): #this is the method responsible for detecting lines
    def __init__(self, line):
        threading.Thread.__init__(self)
        self.line = line 
        
    def run(self):
        #blur = cv2.GaussianBlur(self.line, (21,39), 0)
        blur = cv2.medianBlur(self.line, 41)
        ...
        if lines is not None:
            ...
            #methods to determine turning based on slope of lines detected
            if((slope > 0) & (slope < 7)):
...
#    print(__doc__)
    ...
    for i in range(0, strip.numPixels(), 2):
        strip.setPixelColor(i, Color(127,127,127))
        strip.show()
    print ("Lights are up and running!")
